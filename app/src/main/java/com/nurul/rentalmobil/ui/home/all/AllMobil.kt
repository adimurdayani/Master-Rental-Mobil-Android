package com.nurul.rentalmobil.ui.home.all
...
class AllMobil : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_all_mobil)
        setinit()
        setDisplay()
        setButton()
    }
    ...
    private fun getAllkategori() {
        ...
        ApiConfig.instanceRetrofit.mobil().enqueue(object : Callback<ResponseModel> {
